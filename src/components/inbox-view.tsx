...
export default function InboxView({ user, onLogout }: { user: any; onLogout: () => void }) {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden bg-[#030108] text-white">
      ...
      <aside className={`${selected || activeTab === 'insights' ? 'hidden md:flex' : 'flex'} w-full md:w-80 border-r border-purple-500/10 flex-col bg-[#06030f]/80 backdrop-blur-xl relative z-10 h-screen md:h-auto overflow-y-auto md:overflow-hidden`}>
